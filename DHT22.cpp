...
Version 0.6: 26 Nov 2020 by Carlo Alberto Degli Atti
Fixed protocol to work with DHT22/AM2302 from AZ-Delivery
(see docs/AZDelivery-DHT22-AM2302-Protocol):
- added missing check for the ACK HIGH Pulse
- set a higher threshold (from 11 to 24, hence from 22us to 48us)
to discriminate 0s and 1s in data pulses
...
DHT22_ERROR_t DHT22::readData()
{
  ...
  // Find the end of the ACK LOW Pulse
  retryCount = 0;
  do
  {
  ...
  // Find the end of the ACK HIGH Pulse
  retryCount = 0;
  do
  {
    if (retryCount > 50) //(Spec is 80 us, 50*2 == 100 us)
  ...
  // Spec: 1 is 70 us
  // bitTimes[x] <= 24 is a 0
  // bitTimes[x] >  24 is a 1
